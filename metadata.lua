...
--- Plugin description
PLUGIN.description = "Protobuf plugin, https://github.com/protocolbuffers/protobuf#protobuf-compiler-installation"
...
NOTE:
 ...
 --]]
PLUGIN.manifestUrl = "https://github.com/ahai-code/vfox-protobuf/releases/download/manifest/manifest.json"
